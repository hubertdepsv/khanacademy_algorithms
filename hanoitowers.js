...
var solveHanoi = function(numDisks, fromPeg, toPeg) {
    ...
    // recursive case:
    var sparePeg = hanoi.getSparePeg(fromPeg, toPeg); // get the third disk
    solveHanoi(numDisks - 1, fromPeg, sparePeg); // move this disk from fromPeg to toPeg
    hanoi.moveDisk(fromPeg, toPeg); //from fromPeg to toPeg
